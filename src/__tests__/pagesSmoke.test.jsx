...
jest.mock('../index', () => {
  // Use require to avoid ESM hoisting issues in Jest
...
beforeEach(() => {
  // Default mock for all fetches in pages/components
...
describe('Pages smoke', () => {
  ...
  // Cleanup register page to avoid duplicate fields
  await cleanup();

    // Now login with same creds
