  ...
  <meta property="og:site_name" content="ShopSmart" />
      ...
      <div className="container my-3 py-3">
        ...
        <div className="lead text-center">
          <b>Welcome to ShopSmart!</b> <br/>
          ShopSmart is your one-stop destination for the latest trends, exclusive deals, and a seamless shopping experience. <br/>
          <br/>
          <b>Why Shop With Us?</b><br/>
          <ul className="text-start mx-auto" style={{maxWidth: 700}}>
            <li>Wide range of products for all your needs</li>
            <li>Modern, user-friendly, and responsive design</li>
          ...
          <br/>
          <b>Our Mission</b><br/>
          To make online shopping smarter, easier, and more enjoyable for everyone.<br/>
        </div>
